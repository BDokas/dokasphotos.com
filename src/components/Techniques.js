...
class Flower_Prints extends Component {
   render() {
      return (
         <div>
            <div className="bg-blur" onClick={() => {handleClick(this)}}/>
...
class Making_Prints extends Component {
   render() {
...
class Making_Prints_Details extends Component {
   render() {
      return (
         <div>
         <div className="bg-blur" onClick={() => {handleClick(this)}}/>
...
class Enlarger extends Component {
   render() {
...
class Ground_Glass extends Component {
   render() {
      return (
         <div>
         <div className="bg-blur" onClick={() => {handleClick(this)}}/>
